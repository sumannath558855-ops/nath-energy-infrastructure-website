  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07131e] text-white">
      ...
      <div className="relative flex flex-col items-center gap-5">
        <div className="relative flex h-32 w-44 items-center justify-center overflow-hidden rounded-[2rem] border border-white/20 bg-white p-2 text-lg font-semibold text-primary-foreground shadow-[0_24px_70px_rgba(0,0,0,0.28)] supports-backdrop-filter:backdrop-blur-xl">
